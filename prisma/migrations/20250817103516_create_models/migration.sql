...
CREATE TABLE "public"."DealerShipInfo" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL DEFAULT 'vechile motors',
    "address" TEXT NOT NULL DEFAULT '123 Main St, Anytown, USA',
    "email" TEXT NOT NULL DEFAULT 'contact@vibeCar.com',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "UserSavedCar_savedAt_idx" ON "public"."UserSavedCar"("savedAt");
