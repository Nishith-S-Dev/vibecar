  ...
  const filterSections = [
    {
      id: "make",
      title: "Make",
      options: Array.isArray(filters.makes) ? filters.makes.map((make) => ({ value: make, label: make })) : [],
      currentValue: make,
    ...
    },
    {
      id: "bodyType",
      title: "Body Type",
      options: Array.isArray(filters.bodyType) ? filters.bodyType.map((type) => ({ value: type, label: type })) : [],
    ...
    },
    {
      id: "fuelType",
      title: "Fuel Type",
      options: Array.isArray(filters.fuelType) ? filters.fuelType.map((type) => ({ value: type, label: type })) : [],
    ...
    },
    {
      id: "transmission",
      title: "Transmission",
      options: Array.isArray(filters.transmission) ? filters.transmission.map((type) => ({
        value: type,
        label: type,
      })) : [],
      ...
      <div className="space-y-4">
        ...
        <div className="px-2">
          <Slider
            ...
            step={100}
            value={Array.isArray(priceRange) ? priceRange : [filters.priceRange?.min ?? 0, filters.priceRange?.max ?? 100000]}
            onValueChange={(value) => onFilterChange("priceRange", value)}
          />
        </div>
        <div className="flex items-center justify-between">
          <div className="font-medium text-sm">$ {Array.isArray(priceRange) ? priceRange[0] : filters.priceRange?.min ?? 0}</div>
          <div className="font-medium text-sm">$ {Array.isArray(priceRange) ? priceRange[1] : filters.priceRange?.max ?? 100000}</div>
        </div>
      </div>
